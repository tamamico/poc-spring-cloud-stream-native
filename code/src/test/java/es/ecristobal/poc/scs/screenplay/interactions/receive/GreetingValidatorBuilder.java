...
public class GreetingValidatorBuilder {
    ...
    private GreetingValidatorBuilder() {
    ...
    public static GreetingValidatorBuilder withKafka() {
        return new GreetingValidatorBuilder();
    }

    public GreetingValidatorBuilder withUrls(
            final String broker,
    ...
    public GreetingValidatorBuilder withAuthentication(
